...
class LoanAssistant {
    ...
    LoanAssistant(){
        ...
        final JButton next=new JButton("New Loan Analysis");
        final JButton byMonth=new JButton("X");
        final JButton byNo=new JButton("X");
        final JTextField loan=new JTextField();
        final JTextField interest=new JTextField();
        final JTextField payments=new JTextField();
        final JTextField months=new JTextField();
